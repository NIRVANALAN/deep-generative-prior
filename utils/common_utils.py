...
def add_dgp_parser(parser):
    ...
    parser.add_argument(
        '--exp_path', type=str, default='', help='Experiment path (default: %(default)s)')
    parser.add_argument(
        '--root_dir', type=str, default='', help='Root path of dataset (default: %(default)s)')
    parser.add_argument(
        '--list_file', type=str, default='', help='List file of the dataset (default: %(default)s)')
    parser.add_argument(
        '--resolution',
        type=int,
        default=256,
    ...
    parser.add_argument(
        '--warm_up', type=int, default=0, help='Number of warmup iterations (default: %(default)s)')
    parser.add_argument(
        '--use_in',
        type=str2bool,
